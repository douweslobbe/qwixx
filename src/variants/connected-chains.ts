...
// Connected Chains: Als je een vakje aankruist dat horizontaal grenst aan
// een al aangekruist vakje, wordt het aangrenzende vakje automatisch
// nogmaals geteld (ketting-effect).
export const connectedChainsVariant: VariantConfig = {
  id: 'connected-chains',
  naam: 'Qwixx Connected Chains',
  beschrijving: 'Kettingreactie: aangrenzende kruisjes in dezelfde rij geven bonuspunten.',
  rijen: [
    {
  ...
  bonussen: [
    {
      type: 'ketting',
      beschrijving: 'Bonuspunten per aaneengesloten ketting van kruisjes in een rij',
      params: { puntenPerKetting: [0, 0, 1, 3, 5, 8, 12, 16, 21, 27, 34] },
    },
  ],
};
